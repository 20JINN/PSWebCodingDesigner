    ...
    function gradient(startColor, endColor, steps) {
        ...
        // var pallete = gradient('#012000','#ffffff',10);
        // colorIndex = 0;

        // function changeColor(){
        //   var colorShade = document.querySelector('.color-shade');
        //   colorShade.style.backgroundColor = pallete[colorIndex];
        //   colorIndex = (colorIndex + 1) % pallete.length
        // }
    ...
    //   let colors = [];
    //   for (let i = 0; i < 6; i++) colors.push(randomRgbaString());
    //   console.log(colors);
    ...
    //           updateGradient();
          ...
          for (let i = 0; i < 10; i++) colorss.push(randomRgbaString());
              ...
              var color2 = "rgb("+r2+","+g2+","+b2+")";
               ...
               clock.style.background = "linear-gradient(to right, " + color1 + "," + color2 + ")" ;
               clock.style.backgroundOrigin = "border-box";
                //  .css({
